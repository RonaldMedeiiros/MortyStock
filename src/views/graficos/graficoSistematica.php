...
try {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $data[] = array($sistema_entrega, $total_sistema);
    }
...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('columnchart_material_cd'));
  ...
  <body>
    ...
    <div id="columnchart_material_cd" style="margin-top: -60px; margin-left: -55px;"></div>
  </body>
</html>